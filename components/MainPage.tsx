    ...
    <div className="relative w-full z-10 text-white min-h-screen">
      ...
      <nav className="nav-header fixed top-0 left-0 w-full z-50 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 h-[80px] flex items-center justify-between">
          ...
          <a href="#hero-form" className="hidden lg:flex items-center justify-center border border-[#E8A020] text-[#E8A020] px-6 py-2.5 text-[13px] tracking-wider uppercase hover:bg-[#E8A020] hover:text-white transition-all duration-300 relative z-50">
            Análise Gratuita
          </a>
      ...
      <div className="menu-panel fixed top-0 right-0 w-[85vw] h-full shadow-2xl bg-[#164580] z-40 translate-x-full flex flex-col justify-center px-10">
         <div className="flex flex-col gap-8 text-2xl font-display font-medium">
             ...
             <a href="#hero-form" onClick={() => setIsMenuOpen(false)} className="menu-link opacity-0 text-[#E8A020] mt-4 text-[16px] uppercase tracking-widest font-body font-bold">Análise Gratuita</a>
         </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 w-full z-10 grid md:grid-cols-[1.2fr_1fr] gap-12 md:gap-16 items-center">
          ...
          <div className="flex flex-col items-start hero-inner">
            ...
            <div className="hero-ctas flex flex-col sm:flex-row gap-4 mb-10 w-full sm:w-auto text-sm tracking-wide uppercase group-tooltip relative">
              <a href="#hero-form" className="shimmer-btn bg-[#E8A020] text-white px-8 py-4 rounded-[2px] hover:bg-[#c98616] transition-colors font-medium text-center flex items-center justify-center">
                Começar Análise
              </a>
              <a href="#como-funciona" className="border border-white/20 text-white px-8 py-4 rounded-[2px] hover:bg-white/5 transition-colors text-center flex items-center justify-center">
                Descobrir Como
              </a>
            </div>
          ...
          <div id="hero-form" className="hero-form-card relative scroll-mt-24">
        ...
        <div className="how-sticky md:sticky top-0 h-auto md:h-[100vh] flex items-center max-w-7xl mx-auto px-6 w-full py-20 md:py-0 overflow-hidden md:flex-row flex-col-reverse justify-center">
          ...
          <div className="how-steps w-full md:w-[45%] flex flex-col justify-center relative min-h-[300px] md:h-[500px] gap-8 md:gap-0 mt-8 md:mt-0">
            ...
            <div className="relative z-10 w-full h-full">
              {[ 
                { title: "Pede a Análise", desc: "Preenches o formulário em 2 minutes. Processo rápido, seguro e sem compromisso." },
      ...
      <section id="simulador" className="simulator relative py-20 md:py-[140px] bg-[#164580] overflow-hidden">
        ...
        <div className="max-w-[700px] mx-auto px-6 relative z-10 text-center">
          ...
          <a href="#hero-form" className="shimmer-btn inline-block bg-[#E8A020] text-white px-8 md:px-10 py-4 md:py-5 text-[13px] md:text-sm tracking-wider uppercase font-medium rounded-[4px] hover:bg-[#c98616] transition-colors reveal text-center">
            Quero Esta Poupança
          </a>
        </div>
      </section>
        ...
        <div className="max-w-[760px] mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "A renegociação afeta negativamente o meu historial de crédito?", a: "De todo. Uma renegociação bem-sucedida ou transferência de crédito melhora a sua taxa de esforço e é vista como uma decisão financeira responsible, não afetando negativamente o seu mapa bancário." }
            ].map((f, i) => (
      ...
      <section id="contacto" className="cta-final bg-[#0F3460] py-24 md:py-[160px] text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <div className="reveal">
             <a href="#hero-form" className="shimmer-btn inline-flex items-center justify-center bg-[#E8A020] text-white h-[56px] px-8 md:px-12 text-[14px] md:text-[16px] tracking-[0.1em] uppercase font-medium rounded-[4px] hover:bg-[#c98616] transition-colors relative z-20 cursor-pointer text-center">
                Começar Agora
             </a>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12 md:mb-16">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <a href="#" className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center hover:border-[#E8A020] hover:text-[#E8A020] transition-colors"><span className="text-xs">ig</span></a>
              <a href="#" className="w-8 h-8 rounded-full border border-white/15 flex items-center justify-center hover:border-[#E8A020] hover:text-[#E8A020] transition-colors"><span className="text-xs">fb</span></a>
            </div>
          </div>
        </div>
